...
const Contract = Contracts.getFromLocal('UserAttributeValidToRule');
...
contract('UserAttributeValidToRule', function ([_, tokenOwner, owner, trustedIntermediary1, trustedIntermediary2, address1, address2, address3, address4, address5]) {
