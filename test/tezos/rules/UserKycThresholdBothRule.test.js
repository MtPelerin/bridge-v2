...
contract('UserKycThresholdBothRule', function ([owner, token, trustedIntermediary1, trustedIntermediary2, address1, address2, address3, address4]) {
  beforeEach(async function () {
    ...
    this.contract = await ContractBuilder.new(tezos, 'ligo/rules/UserKycThresholdBothRule.ligo', {}, {
  ...
  context('Check transfer validity', function () {
    ...
    it('returns that transfer is invalid if from address kyc level is less than kycThreshold', async function () {
    ...
    it('returns that transfer is invalid if to address kyc level is less than kycThreshold', async function () {
