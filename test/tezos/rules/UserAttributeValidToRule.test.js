...
contract('UserAttributeValidToRule', function ([owner, token, trustedIntermediary1, trustedIntermediary2, address1, address2, address3, address4]) {
  beforeEach(async function () {
    ...
    this.contract = await ContractBuilder.new(tezos, 'ligo/rules/UserAttributeValidToRule.ligo', {}, {
      complianceRegistry: this.complianceRegistry.address,
      ruleEngine: this.ruleEngine.address
    });
    await runOperation(tezos, trustedIntermediary1, () => this.complianceRegistry.methods.registerUser(address1.pkh, [0, 100, 130, 100001, 100002], [1874872800, 1, 0, 0, 1]).send());
    await runOperation(tezos, trustedIntermediary1, () => this.complianceRegistry.methods.registerUser(address2.pkh, [0, 100, 130, 100001, 100002], [1874872800, 1, 1, 0, 1]).send());
    await runOperation(tezos, trustedIntermediary1, () => this.complianceRegistry.methods.registerUser(address3.pkh, [0, 100, 130, 100001, 100002], [1874872800, 1, 0, 1, 0]).send());
    await runOperation(tezos, trustedIntermediary1, () => this.complianceRegistry.methods.registerUser(address4.pkh, [0, 100, 130, 100001, 100002], [1874872800, 3, 1, 1, 0]).send());
  });
  ...
  context('Check transfer validity', function () {
    it('returns that transfer is valid if attribute value is more than 0 and global value is 0', async function () {
      await runOperation(tezos, owner, () => this.contract.methods.isTransferValid(20000, 20000, this.callback.address, address1.pkh, BURN_ADDRESS, 100001, address3.pkh, token.pkh, [trustedIntermediary1.pkh, trustedIntermediary2.pkh]).send());
    ...
    it('returns that transfer is valid if attribute value is more than 0 and global value is more than 0', async function () {
      await runOperation(tezos, owner, () => this.contract.methods.isTransferValid(20000, 20000, this.callback.address, address1.pkh, BURN_ADDRESS, 100001, address4.pkh, token.pkh, [trustedIntermediary1.pkh, trustedIntermediary2.pkh]).send());
      const result = await this.ruleEngine.storage();
      result.reason_.should.be.bignumber.equal('0');
      result.valid_.should.be.bignumber.equal('1');
    });
    ...
    it('returns that transfer is valid if attribute value is 0 and global value is more than 0', async function () {
      await runOperation(tezos, owner, () => this.contract.methods.isTransferValid(20000, 20000, this.callback.address, address1.pkh, BURN_ADDRESS, 100001, address2.pkh, token.pkh, [trustedIntermediary1.pkh, trustedIntermediary2.pkh]).send());
      const result = await this.ruleEngine.storage();
      result.reason_.should.be.bignumber.equal('0');
      result.valid_.should.be.bignumber.equal('1');
    });
    ...
    it('returns that transfer is invalid if attribute value is 0 and global value is 0', async function () {
      await runOperation(tezos, owner, () => this.contract.methods.isTransferValid(10000, 10000, this.callback.address, address3.pkh, BURN_ADDRESS, 100001, address1.pkh, token.pkh, [trustedIntermediary1.pkh, trustedIntermediary2.pkh]).send());
      const result = await this.ruleEngine.storage();
