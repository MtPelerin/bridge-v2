...
/**
 * @title YesNoUpdateRule
 * @dev YesNoUpdateRule validates transfer if param _yesNo is more than 0
...
contract YesNoUpdateRule is Initializable, AbstractRule {
  ...
  * @return transferStatus Invalid transfer _yesNo is 0, valid transfer with after hook action otherwise
  ...
  */
  ...
  /**
  * @dev Increment the update count for testing purposes
  */
